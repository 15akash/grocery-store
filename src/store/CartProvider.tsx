...
const cartReducer = (state: any, action: any) => {
	if (action.type === 'ADD') {
		...
		const existingCartItemIndex = state.items.findIndex((item: { id: any }) => item.id === action.item.id);
	...
	if (action.type === 'REMOVE') {
		const existingCartItemIndex = state.items.findIndex((item: { id: any }) => item.id === action.id);
